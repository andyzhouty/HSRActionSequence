        ...
        <div className="rounded-2xl border border-gray-700 bg-gray-800 p-4 shadow">
            <div className="mb-4 grid grid-cols-[112px_minmax(0,1fr)] gap-3">
                ...
                {isCharacterTarget(character) ? (
                    <CharacterNameInput
                        ...
                        placeholder={getTargetDefaultName(
                            character.kind,
                            index,
                        )}
                        onChange={(value) =>
            ...
            <div
                className={`grid gap-3 ${
                    isCharacterTarget(character) ? "grid-cols-2" : "grid-cols-1"
                }`}
            >
                <NumberInput
                    label="速度 v"
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    hasSkillEffect(character.name, "Q", "teamAdvance24") ? (
                        <Toggle
                            className="flex-1"
                            label="2魂"
                            checked={character.hasEidolon2}
                            onChange={() =>
                                ctx.updateCharacter(character.id, (prev) => ({
                                    ...prev,
                                    hasEidolon2: !prev.hasEidolon2,
                                }))
                            }
                        />
                    ) : null}
                    {hasSkillEffect(
                        ...
                        <Toggle
                            className="flex-1"
                            label="4魂"
                            checked={character.hasEidolon4}
                            onChange={() =>
                                ctx.updateCharacter(character.id, (prev) => ({
                                    ...prev,
                                    hasEidolon4: !prev.hasEidolon4,
                                }))
                            }
                        />
                    )}

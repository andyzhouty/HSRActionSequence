...
import { handleAglaeaCountdownAction } from "../mechanics/aglaeaGarmentmaker";
...
import { handleFireflyCountdownAction, isFireflyCountdownAction } from "../mechanics/fireflyCombustion";
import { getActiveOdeLabels, emitMemeAdvanceAction } from "./effects";
import type { ActionState, ActiveOdeState, SimulateActionsInput } from "./types";
import { isAglaeaCountdownAction } from "../mechanics/aglaeaGarmentmaker";
...
export function handleSpecialAction({ input, states, actions, activeOdes, stateIndex, key, actionValue, character, actionNo, calcAhaSpeed, callbacks }: {
	...
	const { emitGodmodeExtraAction, emitSpecialInterruptAction, emitSparxieExtraAction, emitEvernightSelfDestructAction } = callbacks;
